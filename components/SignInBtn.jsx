  ...
  return (
    <div className="max-w-xl mx-auto grid gap-4 mt-10">
      ...
      >
        ...
        <span className="bg-blue-500 text-white px-4 py-3 rounded-md hover:bg-blue-600 transition ease-in-out hover:shadow-inner shadow-2lg">
          Sign in with Google
        </span>
      </button>
      ...
      >
        ...
        <span className="bg-gray-700 text-white px-4 py-3 rounded-md hover:bg-gray-800 transition ease-in-out hover:shadow-inner shadow-2lg">
          Sign in with Github
        </span>
      </button>
    </div>
